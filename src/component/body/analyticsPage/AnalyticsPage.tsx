...
const AnalyticsPage = () => {
  ...
  return (
    <div className="flex flex-col gap-[24px] py-[50px] px-[130px] text-white">
      <p className="text-[48px] font-extrabold text-left text-white">Winners</p>
      <div className="flex justify-start">
        <div className="flex flex-row gap-[16px]">
          <div className="bg-[#E42B2B] rounded-[24px] py-[12px] px-[24px] text-white">
            <p className="text-[18px] leading-[22px] font-semibold capitalize">
              Competitions
            </p>
          </div>
          <div className="rounded-[24px] bg-[rgba(71, 71, 71, 0.08)] border border-[#292C31] py-[12px] px-[24px]">
            <p className="text-[18px] leading-[22px] font-semibold capitalize">
              Head 2 Head
            </p>
          </div>
